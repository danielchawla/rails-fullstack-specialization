...
class Assignment
  ...
  def create_todolist(params)
      ...
      @todolist.list_due_date = params[:due_date].to_date
      @todolist.save
  end
  ...
  def find_allusers(offset, limit)
      ...
      @all_users = User.limit(limit).offset(offset).order(updated_at: :asc)
      @all_users.to_a
  end
  ...
  def find_alllists(offset, limit)
      ...
      @all_lists = TodoList.limit(limit).offset(offset).order(list_due_date: :desc)
      @all_lists.to_a
  end
  ...
  def update_password(id, password_digest)
      ...
      @user = User.find_by_id(id).update(password_digest: password_digest)
  end
  ...
  def update_listname(id, name)
      ...
      # (no return is required)
      @list = TodoList.find_by_id(id).update(list_name: name)
  end 
